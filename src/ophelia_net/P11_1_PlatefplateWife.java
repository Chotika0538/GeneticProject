 ...
 * @author LENOVO
 */
public class P11_1_PlatefplateWife extends javax.swing.JPanel {

    private CardLayout cd;
    private JPanel mainPanel;
    public static String BACKPAGE;
    
    public P11_1_PlatefplateWife(JPanel mainPanel , String back) {
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ophelia_net/fplateWife.jpg"))); // NOI18N
...
//        JFrame f = new JFrame();
//        f.setContentPane(new P11_1_PlatefplateWife());
//        f.setSize(1200,700);
