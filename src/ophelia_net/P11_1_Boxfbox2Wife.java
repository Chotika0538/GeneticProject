...
public class P11_1_Boxfbox2Wife extends javax.swing.JPanel {
    private CardLayout cd;
    private JPanel mainPanel;
    public static String BACKPAGE;
    public P11_1_Boxfbox2Wife(JPanel mainPanel , String back) {
  ...
  public P11_1_Boxfbox2Wife (){
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ophelia_net/fbox2Wife.jpg"))); // NOI18N
        add(jLabel1);
