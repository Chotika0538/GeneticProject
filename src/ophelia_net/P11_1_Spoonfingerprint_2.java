 ...
 * @author LENOVO
 */
public class P11_1_Spoonfingerprint_2 extends javax.swing.JPanel {
 
    private CardLayout cd;
    private JPanel mainPanel;
    public static String BACKPAGE;
    public static final String ADDRESS = "Spoon2";
    private ButtonGroup group;
    
    public P11_1_Spoonfingerprint_2(JPanel mainPanel) {
    ...
    private void initComponents() {
        ...
        add(confirmBT);
        confirmBT.setBounds(1030, 600, 100, 40);
        ...
        add(finger1LB);
        finger1LB.setBounds(110, 130, 190, 90);
        ...
        add(chooseRicko);
        chooseRicko.setBounds(640, 90, 20, 20);

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ophelia_net/fspoon2Main.png"))); // NOI18N
    ...
    private void confirmBTActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_confirmBTActionPerformed
        if(!chooseAmi.isSelected() && !chooseDesmond.isSelected() && !choosePoppy.isSelected()&& !chooseRicko.isSelected())
            ...
            P11_1_1chooseFingerEvi.checked[1]=true;
    ...
    private void zoomPoppyBTActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_zoomPoppyBTActionPerformed
        cd.show(mainPanel, "Spoon2Sister");
    ...
    private void zoomDesmondBTActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_zoomDesmondBTActionPerformed
        cd.show(mainPanel, "Spoon2Waiter");
...
private void addPage(){
        mainPanel.add(new P11_1_SpoonfspoonRicko_2(mainPanel,ADDRESS),"Spoon2Ricko");
        mainPanel.add(new P11_1_SpoonfspoonSister_2(mainPanel,ADDRESS),"Spoon2Sister");
        mainPanel.add(new P11_1_SpoonfspoonWaiter_2(mainPanel,ADDRESS),"Spoon2Waiter");
        mainPanel.add(new P11_1_SpoonfspoonWife_2(mainPanel,ADDRESS),"Spoon2Wife");
    }
