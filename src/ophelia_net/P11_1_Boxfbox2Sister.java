...
public class P11_1_Boxfbox2Sister extends javax.swing.JPanel {
    private CardLayout cd;
    private JPanel mainPanel;
    public static String BACKPAGE;
    public P11_1_Boxfbox2Sister(JPanel mainPanel , String back) {
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ophelia_net/fbox2Sister.jpg"))); // NOI18N
        add(jLabel1);
