 ...
 * @author LENOVO
 */
public class P11_1_Spoonfingerprint extends javax.swing.JPanel {

    /**
     * Creates new form fingerprintspoon
     */
    public P11_1_Spoonfingerprint() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ophelia_net/fspoon.jpg"))); // NOI18N
  ...
  /* testing panel*/
    public static void main(String[] args){
        JFrame f = new JFrame();
        f.setContentPane(new P11_1_Spoonfingerprint());
        f.setSize(1200,700);
