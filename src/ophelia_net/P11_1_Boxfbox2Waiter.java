...
public class P11_1_Boxfbox2Waiter extends javax.swing.JPanel {
    private CardLayout cd;
    private JPanel mainPanel;
    public static String BACKPAGE;
    public P11_1_Boxfbox2Waiter(JPanel mainPanel , String back) {
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ophelia_net/fbox2Waiter.jpg"))); // NOI18N
        add(jLabel1);
