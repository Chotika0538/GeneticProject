...
public class P11_3_2_3format16S extends javax.swing.JPanel {
    ...
    /**
     * Creates new form P11_3_2_3format16S
     */
    public P11_3_2_3format16S() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ophelia_net/format16s.jpg"))); // NOI18N
 ...
 /* testing panel*/
    public static void main(String[] args){
        JFrame f = new JFrame();
        f.setContentPane(new P11_3_2_3format16S());
        f.setSize(1200,700);
