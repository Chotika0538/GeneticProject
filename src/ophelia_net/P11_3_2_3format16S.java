 ...
 * @author LENOVO
 */
public class P11_3_2_3format16S extends javax.swing.JPanel {
    private CardLayout cd;
    private JPanel mainPanel;
    private static final String ADDRESS="format3";
    
    public P11_3_2_3format16S(JPanel mainPanel) {
    ...
    private void initComponents() {
        ...
        add(backBT);
        backBT.setBounds(80, 610, 120, 50);
        ...
        jLabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ophelia_net/contam_16s.png"))); // NOI18N
